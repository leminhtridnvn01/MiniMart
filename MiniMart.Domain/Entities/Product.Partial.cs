...
namespace MiniMart.Domain.Entities
{
    ...
    {
        public void Update(string name, string description, int? price, int? priceDecreases, int? currentPriceDecreases, Category category, LK_ProductUnit lK_ProductUnit, string img, int? quantity, int storeId)
        {
            Name = name;
